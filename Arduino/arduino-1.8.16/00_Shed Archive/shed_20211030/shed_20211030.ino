...
const int dk_fans = 25; //this is the pin on the board where the SS relay is attached for the fans in the dog kennel
const int comp_fans = 24;// this is the 12V relay that controls the fans in the computer box
const int shed_fan = 26; //This is the fan for the shed
...
DeviceAddress shed_temp = { 0x28, 0xD6, 0xE4, 0x10, 0x4C, 0x20, 0x01, 0x80 };// this is the shed sensor in the rafters
DeviceAddress cricket_temp = { 0x28, 0x8A, 0x95, 0xF7, 0x4B, 0x20, 0x1, 0xC6 };// this is cricket
DeviceAddress outside_temp = {0x28, 0xD6, 0xE4, 0x10, 0x4C, 0x20, 0x01, 0x80 };// This is the outside sensor in weather station
  ...
  **************************************************************************/
  void Temps() {
    ...
    *************************************************************************************************/
    ...
    if (tempF1 >= 85) {
      digitalWrite (comp_fans,LOW);//i need to figure outif the relay is NC or NO
    }
    else {
