...
void loop() {
  ...
  digitalWrite(motor_comm_pwr, HIGH);
  ...
  Serial.print("Close ");Serial.print(close_value); Serial.print("     Open "   );Serial.print(open_value);Serial.print("   temp  "); Serial.println(tempF1);
  delay(100);

  /*
     Window is going from CLOSE to OPEN
  */
  if ((tempF1 > 65) && (currentMillis - win_previousMillis >= win_time)) {
